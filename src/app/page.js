    ...
    <main className="flex flex-1 flex-col items-center justify-center p-8 bg-transparent text-white">
      <div className="max-w-xl w-full bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col gap-8 items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* כפתור למחולל תמונות */}
          <div>
            <Link href="/image_generator" className="block w-full text-white font-bold py-4 rounded text-center text-xl transition hover:brightness-110" style={{ backgroundColor: '#d84315' }}>
              מחולל תמונות
            </Link>
          </div>
        </div>
